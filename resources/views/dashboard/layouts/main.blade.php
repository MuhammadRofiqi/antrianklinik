    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            ...
            <a href="/dashboard" class="logo d-flex align-items-center">
                ...
                <span class="d-none d-lg-block">Klinik dr. Endang</span>
            </a>
        </div><!-- End Logo -->
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="/dashboard/antrian/nonbpjs">
                            <i class="bi bi-circle"></i><span>Non BPJS</span>
                        </a>
                    </li>
                    <li>
                        <a href="/dashboard/antrian/bpjs">
                            <i class="bi bi-circle"></i><span>BPJS</span>
                        </a>
                    </li>
                    <li>
                        <a href="/dashboard/antrian/darurat">
                            <i class="bi bi-circle"></i><span>Darurat</span>
                        </a>
                    </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/dashboard/pengguna/pengguna">
